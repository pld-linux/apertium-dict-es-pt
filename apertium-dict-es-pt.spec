Summary:	Spanish-Portuguese language pair for Apertium
...
between Spanish and Portuguese, morphological analysis or
part-of-speech tagging of both languages.

%description -l pl.UTF-8
Ten pakiet zawiera parę języków dla Apertium służącą do tłumaczenia
między hiszpańskim a portugalskim, a także analizy morfologicznej lub
...
%{_datadir}/apertium/modes/es-pt.mode
%{_datadir}/apertium/modes/es-pt_BR.mode
%{_datadir}/apertium/modes/pt-es.mode
